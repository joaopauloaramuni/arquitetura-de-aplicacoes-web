...
import com.example.JWT_RestAPI.facade.AuthFacade;
...
public class AuthController {
    ...
    public LoginResponseDTO login(@RequestBody LoginRequestDTO request) {
        ...
        // Primeiro autenticamos o usuário para depois gerar o token JWT
        ...
        // Gera o Token
        String token = authFacade.generateToken(authentication.getName());
    ...
    */
    ...
    public String extractUsername(@PathVariable String token) {
        ...
        String username = authFacade.extractUsername(token);
        return username;
    }
